...
export const generateReportPdf = async (req, res) => {
  try {
    ...
    const headerImg = path.join(process.cwd(), "public", "letter_head.jpg");
    ...
    doc
      ...
      .fillColor("#666")
      .font("Helvetica")
      .text("Evaluator's Signature and Stamp", 50, sigY + 8, { width: 200, align: "center" })
      .text("Student's Signature", 320, sigY + 8, { width: 200, align: "center" });
...
export const generateReportPreviewPdf = async (req, res) => {
  try {
    ...
    // Calculate text height FIRST
    doc.fontSize(10).font("Helvetica");
    const remarksText = overallRemarks || "-";
